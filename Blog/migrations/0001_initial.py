# Generated by Django 4.1.4 on 2023-04-10 10:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.CharField(choices=[('Contributor', 'Contributor'), ('Author', 'Author'), ('Moderator', 'Moderator'), ('Admin', 'Admin'), ('Banned', 'Banned')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(blank=True, null=True)),
                ('type', models.CharField(choices=[('Like', 'Like'), ('Comment', 'Comment'), ('Follow', 'Follow'), ('Notice', 'Notice')], default=None, max_length=255)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('date', models.DateTimeField(default=datetime.datetime.now)),
                ('status', models.CharField(blank=True, choices=[('Published', 'Published'), ('Rejected', 'Rejected')], max_length=255, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('note', models.TextField(blank=True, null=True)),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('commenter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_comment', to=settings.AUTH_USER_MODEL)),
