# Generated by Django 4.2.4 on 2023-10-07 08:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setting', models.CharField(blank=True, choices=[('forbidden-username', 'forbidden-username'), ('comment-per-page', 'comment-per-page'), ('post-per-page', 'post-per-page'), ('notice', 'notice'), ('script', 'script'), ('imgbb-apikey', 'imgbb-apikey')], default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photo', models.ImageField(blank=True, upload_to=Blog.models.post_cover)),
                ('content', models.TextField()),
                ('date', models.DateTimeField(default=datetime.datetime.now)),
                ...
                ('dislike', models.ManyToManyField(blank=True, related_name='user_dislike', to=settings.AUTH_USER_MODEL)),
